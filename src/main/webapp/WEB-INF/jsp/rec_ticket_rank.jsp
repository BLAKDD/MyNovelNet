    ...
    <div class="box-right">
        ...
        <ul class="kind-menu">
            <div class="rank-tab-box">
                <a class="act" href="javascript:" id="_week_recom" onclick="changeRank('_week_recom')">周榜</a>
                <a class="" href="javascript:" id="_month_recom" onclick="changeRank('_month_recom')">月榜</a>
                <a class="" href="javascript:" id="_recom" onclick="changeRank('_recom')">总榜</a>
            </div>
        </ul>
...
<script src="${pageContext.request.contextPath}/static/js/recTicketRank.js"></script>
